...
for category in Path('/Users/sanjaykazi/Desktop/Techcorp_ai/rag-project/techcorp-docs').iterdir():
    if category.is_dir():
...
# Save results
with open('/Users/sanjaykazi/Desktop/Techcorp_ai/rag-project/ingest-complete.txt', 'w') as f:
